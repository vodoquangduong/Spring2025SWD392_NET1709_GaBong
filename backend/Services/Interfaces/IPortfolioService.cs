...
namespace Services.Interfaces
{
    public interface IPortfolioService
    {
        ...
        Task<Result<PublicPortfolioDTO>> GetVerifiedPublicPortfolioByFreelancerIdAsync(long id);
        Task<Result<PublicPortfolioDTO>> GetPendingPublicPortfolioByFreelancerIdAsync(long id);
