    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity
                    .HasMany(e => e.FreelancerProjects)
                    .WithOne(e => e.Freelancer)
                    .HasForeignKey("FreelancerId")
                    .OnDelete(DeleteBehavior.Restrict);

                entity
                    .HasMany(e => e.VerifyStaffIdProjects)
                    .WithOne(e => e.Verifier)
                    .HasForeignKey("VerifyStaffId")
                    .OnDelete(DeleteBehavior.Restrict);

                entity
                    .HasMany(e => e.SenderReports)
                    .WithOne(e => e.Sender)
                    .HasForeignKey("SenderId")
                    .OnDelete(DeleteBehavior.Restrict);

                entity
                    .HasMany(e => e.VerifiedReports)
                    .WithOne(e => e.VerifyStaff)
                    .HasForeignKey("VerifyStaffId")
                    .OnDelete(DeleteBehavior.Restrict);

                entity
                    .HasMany(e => e.SkillPerforms)
                    .WithOne(e => e.Account)
                ...
                entity.HasMany(e => e.Bids).WithOne(e => e.BidOwner).HasForeignKey("BidOwnerId");
            ...
            modelBuilder.Entity<Project>(entity =>
            {
                ...
                entity.HasMany(e => e.Reports).WithOne(e => e.Project).HasForeignKey("ProjectId");
                entity
                    .HasMany(e => e.SkillRequired)
                    .WithOne(e => e.Project)
                ...
                entity
                    ...
                    .WithOne(e => e.Project)
                    .HasForeignKey("ProjectId");
                entity.HasMany(e => e.Contracts).WithOne(e => e.Project).HasForeignKey("ProjectId");
                entity.HasMany(e => e.Feedbacks).WithOne(e => e.Project).HasForeignKey("ProjectId");
            });
