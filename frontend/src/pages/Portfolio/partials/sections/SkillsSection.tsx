      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {certifications.map((cert) => (
            <div
              key={cert.id}
              className="group p-4 bg-white dark:bg-gray-800/50 backdrop-blur-xl border border-gray-100 dark:border-gray-700/50 rounded-lg hover:shadow-lg hover:shadow-emerald-500/10 transition-all"
            >
